        ...
        >
          <ParallaxLayer className={layerClassName} offset={0}>
            ...
            <p>
              ...
              gamers forced to adapt to the new reality of remote work and
              social distancing. At the same time, the crypto craze has caused
              waves in the technology sector, with cryptocurrency mining driving
              up demand for high-performance graphics cards (GPUs).
            </p>
            <p>
          ...
          >
            <section>
              ...
              <p>
                Surprisingly, the NVIDIA GeForce GTX 1060 held its position as
                the most popular GPU for an extended period of time during the
                pandemic, and even its designated successor, the RTX 2060,
                failed to dethrone it. In fact, the RTX 3060 took over the third
                spot from the RTX 2060 at the start of 2023. Notably, the 20
                series GPUs had poor adoption rates among gamers, who seemed to
                prefer their old GTX 1060 or the newer budget-friendly version
            ...
            <section>
              ...
              <p>
                ...
                market, not all cards are created equal. As we saw in the
                previous section, the NVIDIA GeForce GTX 1060 remained the most
                popular GPU among PC gamers for an extended period of time
                during the pandemic, even as newer cards were released. But what
                factors contributed to its sustained popularity, and how did the
                marketing and performance of other cards affect their adoption
                rates? In this section, we dive deeper into the GPU benchmark
                data to explore these questions.
              </p>
            </section>
          </ParallaxLayer>
          <ParallaxLayer
          ...
          >
            <section>
              ...
              <p>
                Overall, our analysis suggests that while performance is
                certainly a key factor, other factors such as availability and
                marketing play a significant role in the adoption of GPUs among
                PC gamers.
              </p>
            </section>
            <section>
              ...
              <p>
                ...
                disrupting not only our daily lives but also global supply
                chains, causing a severe shortage of computer chips. As GPUs
                heavily rely on the most advanced chip design, this has had a
                direct impact on their production and availability. But how has
                this affected the adoption and availability of GPUs worldwide?
                Did the pandemic and chip shortage have a different impact from
                countries that are major suppliers of GPUs like China, compared
                to major consumer countries like the United States? Moreover,
                did different GPUs react differently?
              </p>
            </section>
          </ParallaxLayer>
          <ParallaxLayer
          ...
          >
            <section>
              ...
              <p>
                Looking at the relationship between COVID-19 and GPU adoption,
                we see that after the first wave of the pandemic, the shares of
                RTX 3060 and RTX 3060 Ti increased while the shares of RTX 3090
                and RTX 3080 remained stable. After the spike in cases caused by
                the Omicron variant, many 30 series GPUs saw an increase in
                shares as COVID-19 cases decreased. However, shares of the
                high-end RTX 3080 Ti and RTX 3090 remained relatively unchanged
          ...
          >
            <section>
              <p>
                The NVIDIA GTX 1060 remains one of the most popular graphics
                cards in the gaming world, even years after its release. It was
              ...
              <p>
                As the pandemic comes to an end, it will be interesting to see
                if the popularity of the GTX 1060 continues or if gamers will
                finally switch to newer models.
              </p>
              <br />
          ...
          >
            <section>
              ...
              <p>
                ...
                challenges in the production and availability of GPUs. At the
                same time, the rise of cryptocurrency mining has created
                additional demand for GPUs, further driving up prices and
                exacerbating the scarcity of GPUs in the market. In this
                section, we will explore the correlation between the adoption of
                GPUs and the price of Ethereum (ETH), one of the most popular
                cryptocurrencies at the time, through a pie chart visualization
                of GPU shares with ETH price as the radius. We will discuss how
                the crypto craze has affected the availability and affordability
                of GPUs for gamers.
              </p>
            </section>
          </ParallaxLayer>
          ...
          >
            ...
            <section>
              ...
              <p>
                ...
                scores were merged. For example, GTX 1060 6G and GTX 1060 3G
                were put together as one GTX 1060 with their scores averaged.
              </p>
              <p>
